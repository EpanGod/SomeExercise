...
public static class  InIRead
{
    ...
    public static string[] INIGetAllSectionNames(string iniFile)
    {
        ...
        uint bytesReturned = InIRead.GetPrivateProfileSectionNames(pReturnedString, MAX_BUFFER, iniFile);
        if (bytesReturned != 0)
        {
            //读取指定内存的内容  
    ...
    public static string[] INIGetAllItems(string iniFile, string section)
    {
        ...
        uint bytesReturned = InIRead.GetPrivateProfileSection(section, pReturnedString, MAX_BUFFER, iniFile);
    ...
    public static string[] INIGetAllItemKeys(string section, string iniFile)
    {
        ...
        uint bytesReturned = InIRead.GetPrivateProfileString(section, null, null, chars, SIZE, iniFile);
    ...
    public static string INIGetStringValue(string section, string key, string defaultValue, string iniFile)
    {
        ...
        uint bytesReturned = InIRead.GetPrivateProfileString(section, key, defaultValue, sb, SIZE, iniFile);
    ...
    public static bool INIWriteItems(string iniFile, string section, string items)
    {
        ...
        return InIRead.WritePrivateProfileSection(section, items, iniFile);
    }
    ...
    public static bool INIWriteValue(string iniFile, string section, string key, string value)
    {
        ...
        return InIRead.WritePrivateProfileString(section, key, value, iniFile);
    ...
    public static bool INIDeleteKey(string iniFile, string section, string key)
    {
        ...
        return InIRead.WritePrivateProfileString(section, key, null, iniFile);
    }
    ...
    public static bool INIDeleteSection(string iniFile, string section)
    {
        ...
        return InIRead.WritePrivateProfileString(section, null, null, iniFile);
    }
    ...
    public static bool INIEmptySection(string iniFile, string section)
    {
        ...
        return InIRead.WritePrivateProfileSection(section, string.Empty, iniFile);
    }


    private static void TestIniINIOperation()
    {
